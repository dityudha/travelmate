	...
	<section id="content" class="slideshow-bg">
		<div id="slideshow">
			<div class="flexslider">
				<ul class="slides">
					<li>
						<div class="slidebg" style="background-image: url('<?php echo base_url(); ?>gudang/images/slider/banner.jpg');"></div>
					</li>
				</ul>
			</div>
		</div>
		<div class="container">
			<div id="main">
				<h1 class="page-title" object align="right">Your Best Traveling Mate</h1>
				<h2 class="page-description" object align="right">Best Price With Best Services</h2>
						...
						<div class="search-tab-content"><!-- KOTAK PENCARIAN -->
							...
							<div class="tab-pane fade active in" id="flights-tab">
								<form action="<?php echo base_url(); ?>pesawat/cari" method="get">
									<h6 class="title"><b>Kemana Destinasi Tujuan Anda?</b></h6>
									<div class="row">
										<div class="col-md-4">
