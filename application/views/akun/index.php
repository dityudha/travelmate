				...
				<div class="tab-container full-width-style arrow-left dashboard">
					...
					<div class="tab-content">
						<div id="dashboard" class="tab-pane fade in active">
							...
							<h1 class="no-margin skin-color">Hi <?=$kie->nama ?>, Welcome to Travelmate!</h1>
							...
							<div class="notification-area">
								<div class="info-box block">
									...
									<br />
									<ul class="circle">
										<li><span class="skin-color">Learn How It Works</span> — Watch a short video that shows you how Travelmate works.</li>
										<li><span class="skin-color">Get Help</span> — View our help section and FAQs to get started on Travelmate. </li>
									</ul>
								</div>
							</div>
						</div>
						<div id="profile" class="tab-pane fade">
							<div class="view-profile">
								...
								<h2>About You</h2>
								<div class="intro">
									<p>Ini adalah halaman akun anda, disini anda dapat mengakses beberapa menu informasi seperti melihat hasil tiket yang telah anda booking maupun yang lain nya.</p>
								</div>
							</div>
