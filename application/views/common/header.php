			...
			<ul class="quick-menu pull-right">
				<li class="ribbon currency">
					...
					<ul class="menu mini">
						...
						if ($wkwk = $wkwk) {
							echo "<li><a href=\"http://localhost/travelmate/akun/\" title=\"My Profile\">Profile</a></li>";
							echo "<li><a href=\"http://localhost/travelmate/akun/logout\"  title=\"Logout\">Logout</a></li>";
						} else {
							echo "<li><a href=\"http://localhost/travelmate/akun/login\"  title=\"Login\">Login</a></li>";
							echo "<li><a href=\"http://localhost/travelmate/akun/register\"  title=\"Register\">Register</a></li>";
						}
						?>
